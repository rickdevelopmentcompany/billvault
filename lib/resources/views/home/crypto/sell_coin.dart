...
class SellCoinView extends StatefulWidget {
  const SellCoinView({super.key});

  @override
  State<SellCoinView> createState() => SellCoinViewState();
}

class SellCoinViewState extends State<SellCoinView> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Spacer(),
            primaryButton(context, title: 'Sell', onTap: () async {
