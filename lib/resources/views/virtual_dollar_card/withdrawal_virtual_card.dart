...
class WithdrawalVirtualcard extends StatefulWidget {
  const WithdrawalVirtualcard({super.key});

  @override
  State<WithdrawalVirtualcard> createState() => WithdrawalVirtualcardState();
}


class WithdrawalVirtualcardState extends State<WithdrawalVirtualcard>{
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      ...
      body: Obx((){
                            ...
                            Obx((){
                              return Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Balance ~ ${virtualDollarCardController.balance}USD',
        ...
        icon: const Icon(Icons.warning_amber_rounded, color: Colors.white),
        ...
        }else if(double.parse(amountController.text.toString()) > double.parse(virtualDollarCardController.balance)){
          Get.snackbar(
            'Error',
          ...
          paymentController.isLoading.value = true;
                                ...
                                await virtualDollarCardController.withdrawFromCard(amount.toString());
